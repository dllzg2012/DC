<?php /* Smarty version 2.6.18, created on 2013-06-08 21:41:41
...
" ><?php echo $this->_tpl_vars['item']['groupname']; ?>
		  ...
		  <dd class="cl_999" ><?php echo $this->_tpl_vars['item']['membernum']; ?>
人加入</dd>
	     </li>
	     <?php endforeach; endif; unset($_from); ?>
...
?>
	     <li>
	      <img src="./uploadfiles/user/<?php echo $this->_tpl_vars['item']['photo']; ?>
" />
		  <dt class="aff6600"><a href="self_zone.php?uid=<?php echo $this->_tpl_vars['item']['ID']; ?>
"><?php echo $this->_tpl_vars['item']['nickname']; ?>
</a></dt>
		  <dd class="a0693e3">他的热门圈：<a href="grp_single_home.php?ID=<?php echo $this->_tpl_vars['item']['gID']; ?>
"><?php echo $this->_tpl_vars['item']['groupname']; ?>
</a></dd>
		  <dd>成员：<?php echo $this->_tpl_vars['item']['membernum']; ?>
</dd>
		  <dd class="cl_999"><a href="grp_single_home.php?ID=<?php echo $this->_tpl_vars['item']['gID']; ?>
">去看看>></a></dd>
	     </li>
	     <?php endforeach; endif; unset($_from); ?>
