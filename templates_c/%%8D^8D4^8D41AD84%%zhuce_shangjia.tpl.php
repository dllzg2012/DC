<?php /* Smarty version 2.6.18, created on 2013-06-13 12:10:39
         compiled from register/zhuce_shangjia.tpl */ ?>
...
" onfocus="javascript:setPwdEnterError(this,false,'','');"/><span id="tips_pwd_ck"></span><br/><p id="tips_pwd"></p></td>
	</tr>
	<tr>
		<td align="right"><span class="cl_f30">*</span> 重复密码：</td>
		<td><input type="password" name="user[repassword]" id="repwd"
			class="my_txt_350" onblur="check_vali_repwd(this)" value="<?php echo $this->_tpl_vars['temp']['password']; ?>
" onfocus="javascript:setPwdEnterError(this,false,'','');"/><span id="tips_repwd_ck"></span><br/><p id="tips_repwd"/></td>
	</tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<td width="81%"><input type="text" name="user[shopName]" 
			id="shopname" class="my_txt_350" onblur="check_other(this,'tips_shopname','店名')" value="<?php echo $this->_tpl_vars['temp']['shopname']; ?>
" onfocus="javascript:setEnterEorrer(this,false,'','');"/><span id="tips_shopname_ck"></span><br/><p id="tips_shopname"/></td>
	</tr>
	<tr>
		<td align="right"><span class="cl_f30">*</span> 经营范围：</td>
		<td><input type="text" name="user[shopScope]" id="shoptype" value="<?php echo $this->_tpl_vars['temp']['scope']; ?>
"
	...
	<tr>
		...
		<td><input type="text" name="user[shopCharger]" id="shopcharger" value="<?php echo $this->_tpl_vars['temp']['chargeperson']; ?>
"
			...
			value="1" <?php if ($this->_tpl_vars['temp']['sex'] == 1 || $this->_tpl_vars['temp']['sex'] == ""): ?>checked<?php endif; ?>/> 男 <input type="radio" name="user[sex]" value="0" <?php if ($this->_tpl_vars['temp']['sex'] == 0): ?>checked<?php endif; ?>/> 女</label><br/><p id="tips_username"/></td>
	</tr>
	<tr>
		<td align="right"><span class="cl_f30">*</span> 联系电话：</td>
		<td><input type="text" name="user[shopContact]" id="shopnumber"
			class="my_txt_120" onblur="check_vali_number(this)" value="<?php echo $this->_tpl_vars['temp']['contactphone']; ?>
" onfocus="javascript:setEnterEorrer(this,false,'','');"/><span id="tips_shopnumber_ck"></span><br/><p id="tips_shopnumber"/></td>
	</tr>
	<tr>
		<td align="right"><span class="cl_f30">*</span> 门店地址：</td>
		<td><input type="text" name="user[shopAddress]" id="shopaddress" value="<?php echo $this->_tpl_vars['temp']['storeaddr']; ?>
"
	...
	<tr>
		...
		<td><textarea name="user[remark]" rows="8" id="remark"  class="my_txt_350" onblur="check_other(this,'tips_remark','备注')" onfocus="javascript:setEnterEorrer(this,false,'','');"><?php echo $this->_tpl_vars['temp']['remark']; ?>
</textarea><span id="tips_remark_ck"></span><br/><p id="tips_remark"/></td>
	</tr>
	<tr>
