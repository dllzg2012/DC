<?php /* Smarty version 2.6.18, created on 2013-06-07 12:32:23
...
<div class="lt_dh bor_bot1">
    <div class="box2 clearfix">
	  <div class="lt_dh2 clearfix">
	   ...
	   <ul class="home_dh">
	   <li <?php if ($_SESSION['barType'] != 0 || $_SESSION['barType'] == ""): ?>class="small"<?php else: ?>class="barType"<?php endif; ?>><a href="index.php">吾校首页</a></li>
	   <li <?php if ($_SESSION['barType'] != 1): ?>class="small"<?php else: ?>class="barType"<?php endif; ?>><a href="barindex.php">校笑吧</a></li>
	   <li <?php if ($_SESSION['barType'] != 2): ?>class="small"<?php else: ?>class="barType"<?php endif; ?>><a href="grp_home.php">圈子</a></li>
	   <li <?php if ($_SESSION['barType'] != 3): ?>class="small"<?php else: ?>class="barType"<?php endif; ?>><a href="hd.php">活动</a></li>
	   <li <?php if ($_SESSION['barType'] != 4): ?>class="small"<?php else: ?>class="barType"<?php endif; ?>><a href="forum_home.php">校谈</a></li>
	   </ul>
