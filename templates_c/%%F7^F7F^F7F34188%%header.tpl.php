...
<table border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><a href="#">收藏本站</a><span class="xx">|</span></td>
...
<table border="0" cellspacing="0" cellpadding="0" class="main_login">
  <tr>
    ...
    <td><a href="#">帮助中心</a>
    <span class="xx">|</span></td>
    <td><a href="#">商家联盟</a><span class="xx">|</span></td>
    
    <td>
    <div class="menu3">
            <em><A class="menu-hd" href="#">吾爱吾校友情推荐</a></em>
            <div class="menu-bd">
				<div class="menu-bd-panel">
					<ul>
                        <li><A href="#" >吾爱吾校友情推荐</A></li>
						<li><A href="#">吾爱吾校友情推荐</A></li>
					</ul>
				</div>
             </div>
...
<table  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
        <div class="menu4">
            [ <em><A class="menu-hd" href="javascript:void(0)" id="firstcity"><?php echo $this->_tpl_vars['cities'][0]['name']; ?>
</a></em> ]
            <div class="menu-bd">
				<div class="menu-bd-panel">
					<ul id="firstcityarea">
...
<li class="all">
<div class="menu5">
            <p><A class="menu-hd" href="#">大学列表</A></p>
            <div class="menu-bd">
<div class="gakko">
...
<input name="" type="text"  class="gakko_search_txt"/>
<input type="button" class="gakko_search_ann" value="搜索"/>
</form>
</div>
</div>
...
<?php $_from = $this->_tpl_vars['cities']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['item']):
?>
<dd <?php if ($this->_tpl_vars['selcityid'] == $this->_tpl_vars['item']['ID']): ?>class="sel"<?php endif; ?>><?php echo $this->_tpl_vars['item']['name']; ?>
</dd>
<?php endforeach; endif; unset($_from); ?>
...
<p <?php if ($_SESSION['myschooltype'] != 4): ?> class="car" <?php else: ?>class="car backbj"<?php endif; ?>><a href="flow.php?act=index">购物车</a></p>


<p <?php if ($_SESSION['myschooltype'] != 5): ?>class="result" <?php else: ?>class="result backbj"<?php endif; ?>><a href="flow.php?act=checkout">去结算</a></p>
</li>                           
</ul>
</div>
