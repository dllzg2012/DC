...
function AjaxGetUserOrderBack(json)
{
	...
	for(var i=0; i<obj.info.length; i++)
	{
		...
		content += "<td width='56%' class='size12'><a href='#'>"+obj.info[i].orno+"</a></td>";
		content += "<td width='8%' align='center'>￥"+obj.info[i].total+"</td>";
		content += "<td width='11%' align='center'>"+obj.info[i].time+"</td>";
