...
<div class="lt_dh bor_bot1">
    <div class="box2 clearfix">
	  <div class="lt_dh2 clearfix">
	   ...
	   <ul class="home_dh">
	   <li {if $smarty.session.barType neq 0 or $smarty.session.barType eq ""}class="small"{else}class="barType"{/if}><a href="index.php">吾校首页</a></li>
	   <li {if $smarty.session.barType neq 1}class="small"{else}class="barType"{/if}><a href="barindex.php">校笑吧</a></li>
	   <li {if $smarty.session.barType neq 2}class="small"{else}class="barType"{/if}><a href="grp_home.php">圈子</a></li>
	   <li {if $smarty.session.barType neq 3}class="small"{else}class="barType"{/if}><a href="hd.php">活动</a></li>
	   <li {if $smarty.session.barType neq 4}class="small"{else}class="barType"{/if}><a href="forum_home.php">校谈</a></li>
	   </ul>
