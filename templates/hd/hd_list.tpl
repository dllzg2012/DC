   ...
   <div class="box clearfix">
        ...
        <div class="AreaL clearfix">
		   ...
		   <div class="case clearfix">
			  ...
			  <p class="hd_zp">全部</p>
			  <p class="hd_fqhd"><input type="button"  class="hd_ann3" value=""{if $smarty.session.loginok eq 1} onclick="window.location.href='hd.php?module=hd_new'" {else} onclick="LoginOut();" {/if}/></p>
			  </div>
			  ...
			  <div class="hd_calculate clearfix">
				 ...
				 <p class="a0693e3"><a href="hd.php?module=hd_list_pages&order=place&page=1&place={$place.ID}">{$place.place}</a></p>
			  ...
			  <div class="hd_activities clearfix">
    			...
    			<li class="clearfix">
				   ...
				   <div class="info">
					   ...
					   <p>发起：<em class="a0693e3"><a href="#">{$act_list.nickname}</a></em></p>
